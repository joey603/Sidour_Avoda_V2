#!/bin/bash
# Script pour créer un DMG de test avec toutes les solutions
# Usage: ./create-test-dmg.sh

set -euo pipefail

echo "📦 Création du DMG de test avec solutions"
echo "========================================="
echo ""
...
ARCH=$(uname -m)
DMG_NAME="SidourAvoda-Test-${ARCH}.dmg"
